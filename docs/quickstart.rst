...
by the package to allow for testing with |factory-boy|_, include it
in the installation.
...
If |factory-boy|_ is unnecessary, it can be omitted by installing normally.
...
.. |factory-boy| replace:: :code:`factory-boy`
