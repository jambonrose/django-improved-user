...
details) and a set of :doc:`mix-in classes <source/mixin_models>` to allow for
creation of new User models (notably, the
:class:`~improved_user.models.DjangoIntegrationMixin`).
